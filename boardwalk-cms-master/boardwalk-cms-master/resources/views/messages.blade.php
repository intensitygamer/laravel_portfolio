...
@section('content')
    <div id="content-header">
        <div id="breadcrumb"> <a href="/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="messages" class="current">Messages</a> </div>
        <h1>Messages</h1>
    </div>
                ...
                <div class="widget-box widget-chat">
                    ...
                    <div class="widget-content nopadding">
                        <div class="chat-users panel-right2">
                            <div class="panel-title message-panel-title">
                                <h5>Online Users</h5>
                            </div>
